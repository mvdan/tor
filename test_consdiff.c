...
main() {
  ...
  test_consdiff_calc_changes();
  test_consdiff_get_id_hash();
  test_consdiff_is_valid_router_entry();
  test_consdiff_next_router();
  test_consdiff_base64cmp();
  test_consdiff_gen_ed_diff();
